    ...
    return (
        <div className='w-full h-full fixed top-0 left-0 z-20'>
            <div className='max-w-[600px] absolute top-1/2 left-1/2 z-30 bg-zinc-600 rounded-md transform -translate-x-1/2 -translate-y-1/2 p-3 lg:w-[450px] md:w-[450px] sm:w-[450px] w-[400px]'>
                <h3 className="text-2xl text-center font-bold text-white mt-3">{name}</h3>
                ...
                <form onSubmit={handleBooking} className="p-5">
                    ...
                    <input type="text" disabled value={date} className="input input-bordered w-full my-6" />
                    <select name="slot" className="select select-bordered w-full my-6">
                        {
                    ...
                    <input name="name" type="text" placeholder="Your Name" disabled className="input input-bordered w-full my-6" />
                    <input name='email' type="email" placeholder="Email Address" disabled className="my-6 input input-bordered w-full" />
                    <input name='phone' type="text" placeholder="Phone Number" className="input input-bordered w-full my-6" />

                    <input type="submit" className='btn btn-accent w-full mt-6' value="Submit" />
