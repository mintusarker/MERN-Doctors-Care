...
const services = [
    ...
    return (
        <div className='px-12 pt-12 pb-1'>
            <h2 className='text-center capitalize text-2xl font-serif text-success'>services that you take</h2>
            <div className='grid lg:grid-cols-3 md:grid-cols-2 sm:grid-cols-1 gap-11 lg:px-40 px-16 my-16'>
                {
                    services.map(service => 
                        <div className='hero hero-content flex flex-col shadow-xl rounded-md p-8'>
                            <img className='w-24 h-24 text-blue-800' src={service?.img} alt="" />
